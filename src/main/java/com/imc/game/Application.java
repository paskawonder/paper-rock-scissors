...
public final class Application {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Optional<String> winnerId = seriesRunner.play(Byte.parseByte(args[0]), user, computer);
        LOGGER.log(Level.INFO, "The Final Result is {0}", winnerId.map(id -> "Victory of " + id).orElse("Draw"));
    }
